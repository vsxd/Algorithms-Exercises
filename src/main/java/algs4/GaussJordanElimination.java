...
public class GaussJordanElimination {
    ...
    private static void test6() {
        ...
        double[] b = { -3, 1, 6 };
        test("main.java.test 6 (infinitely many solutions)", A, b);
    }
