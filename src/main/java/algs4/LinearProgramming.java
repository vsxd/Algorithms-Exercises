...
public class LinearProgramming {
   ...
   // index of a non-basic column with most positive cost
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("----- main.java.test 1 --------------------");
        test1();
        StdOut.println();

        StdOut.println("----- main.java.test 2 --------------------");
        test2();
        StdOut.println();

        StdOut.println("----- main.java.test 3 --------------------");
        test3();
        StdOut.println();

        StdOut.println("----- main.java.test 4 --------------------");
        test4();
        StdOut.println();

        StdOut.println("----- main.java.test random ---------------");
