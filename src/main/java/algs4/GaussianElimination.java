...
public class GaussianElimination {
    ...
    private static void test1() {
        ...
        double[] b = { 4, 2, 36 };
        test("main.java.test 1 (3-by-3 system, nonsingular)", A, b);
    }
    ...
    private static void test2() {
        ...
        double[] b = { 4, -2, 9 };
        test("main.java.test 2 (3-by-3 system, nonsingular)", A, b);
    }
    ...
    private static void test3() {
        ...
        double[] b = { 4, 4, 9, -6, 5 };
        test("main.java.test 3 (5-by-5 system, no solutions)", A, b);
    }
    ...
    private static void test4() {
        ...
        double[] b = { 4, 4, 9, -5, 5 };
        test("main.java.test 4 (5-by-5 system, infinitely many solutions)", A, b);
    }
    ...
    private static void test5() {
        ...
        double[] b = { 1, 4, 2 };
        test("main.java.test 5 (3-by-3 system, no solutions)", A, b);
    }
    ...
    private static void test6() {
        ...
        double[] b = { -3, 1, 6 };
        test("main.java.test 6 (3-by-3 system, infinitely many solutions)", A, b);
    }
    ...
    private static void test7() {
        ...
        double[] b = { 4, 2, 36, 42 };
        test("main.java.test 7 (4-by-3 system, full rank)", A, b);
    }
    ...
    private static void test8() {
        ...
        double[] b = { 4, 2, 36, 40 };
        test("main.java.test 8 (4-by-3 system, no solution)", A, b);
    }
    ...
    private static void test9() {
        ...
        double[] b = { 4, -2, 9 };
        test("main.java.test 9 (3-by-4 system, full rank)", A, b);
    }
 ...
 *
 *  This file is part of main.java.algs4.jar, which accompanies the textbook
 *
 ...
 *
 *
 *  main.java.algs4.jar is free software: you can redistribute it and/or modify
 *  it under the terms of the GNU General Public License as published by
 *  the Free Software Foundation, either version 3 of the License, or
 *  (at your option) any later version.
 *
 *  main.java.algs4.jar is distributed in the hope that it will be useful,
 *  but WITHOUT ANY WARRANTY; without even the implied warranty of
 *  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 *  GNU General Public License for more details.
 *
 *  You should have received a copy of the GNU General Public License
 *  along with main.java.algs4.jar.  If not, see http://www.gnu.org/licenses.
 ******************************************************************************/
