 ...
 *  bit-main.java.test operations. Because Java does not furnish any generic abstractions
 ...
 *  represents the number of single-bit main.java.test operations (under PATRICIA), and
...
public class PatriciaSET implements Iterable<String> {
     ...
     * This main.java.test fixture runs a series of tests on a randomly generated dataset.
